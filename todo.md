...
- [ ] Reload the updated extension on Legion and verify real browser actions, tab transfer, Stop and screenshots.
- [x] Repair Legion deployment path mismatch: updated the actual Brave-loaded `projects/extentions/nerdbot/dist`, archived its previous build and verified all 42 copied files. Activation/live verification remains in the reload item above.
